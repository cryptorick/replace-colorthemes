;;; late-night-work-theme.el --- late-night-work theme

;; Copyright (C) 2002 by Alex Schroeder
;; Copyright (C) 2013 by Syohei YOSHIDA
;; Tweaks by cryptorick
...
;;; Commentary:
;;
;; Tweak of late-night theme from `color-themes'

;;; Code:

(deftheme late-night-work
  "late-night-work theme")

(custom-theme-set-faces
 'late-night-work

 '(default ((t (:background "#000" :foreground "#aaa"))))
 ...
 '(mode-line-inactive ((t (:background "#000" :foreground "#666"))))
 '(mode-line-buffer-id ((t (:background "#000" :foreground "#777"))))
 '(mode-line-mousable ((t (:background "#000" :foreground "#777"))))
 '(mode-line-mousable-minor-mode ((t (:background "#000" :foreground "#777"))))
...
(provide-theme 'late-night-work)

;;; late-night-work-theme.el ends here
